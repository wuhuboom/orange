...
function initData(){
    ...
    state.bankId = card.bankId
    state.cardNumber = card.cardNumber
    state.cardNumberTwice = card.cardNumber
    state.province = card.province
    state.city = card.city
    state.subBranch = card.subBranch
    state.bankId = card.bankName
...
async function submit() {
    ...
    let url = '/player/bind_bank_card_edit'
    let data = {
